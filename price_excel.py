...
# === 1. Загружаем CSV ===
csv_url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vR7hj61tyAykZN2GpBmKVpvQjlAq-UJCAvc9XwyHPYTgGCdVrrTRWD5Ce-uYIZMpy4guvu6_TWjl4ca/pub?output=csv"
df = pd.read_csv(csv_url)
df = df.sort_values(by="brand", ascending=True)
# Удаляем все колонки, где заголовок содержит 'my_price' или начинается с 'Unnamed'
df = df.loc[:, ~df.columns.str.contains("my_price|^Unnamed")]
# HTML -> текст
...
folder_id = "1QYORdyG_7pMiwCH11ORJ7KxKy7IMe-_n"  # ваша папка на Google Диске
